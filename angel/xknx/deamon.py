import asyncio, getopt, sys, sqlite3, datetime, urllib3, threading, time
...
async def telegram_received_cb(telegram):
    connt = sqlite3.connect('/angel/FlaskApp/hopeitworks.db')
...
if __name__ == "__main__":
    ...
    db = '/angel/FlaskApp/hopeitworks.db'
    try:
    ...
    if internet_on(): internet_bool = True
    else: internet_bool = False
